...
alert("The current view has been copied.");
		...
		els.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
			''+
			'L3N2Zz4K';
		...
		els.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
			'';
		...
		el=me._vr_button=document.createElement('div');
		el.ggId="vr_button";
		el.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1,def:'' };
		el.ggVisible=true;
		el.className="ggskin ggskin_rectangle gradient";
		...
		el.setAttribute('style',hs);
		el.style.transformOrigin='50% 50%';
		me._vr_button.ggIsActive=function() {
			return false;
		}
		el.ggElementNodeId=function() {
			return player.getCurrentNode();
		}
		me._vr_button.logicBlock_scaling = function() {
			var newLogicStateScaling;
			if (
				((me.elementMouseOver['vr_button'] == true))
			)
			{
			...
			if (me._vr_button.ggCurrentLogicStateScaling != newLogicStateScaling) {
				me._vr_button.ggCurrentLogicStateScaling = newLogicStateScaling;
				me._vr_button.style.transition='transform 300ms ease 0ms';
				if (me._vr_button.ggCurrentLogicStateScaling == 0) {
					me._vr_button.ggParameter.sx = 1.2;
					me._vr_button.ggParameter.sy = 1.2;
					me._vr_button.style.transform=parameterToTransform(me._vr_button.ggParameter);
					setTimeout(function() {skin.updateSize(me._vr_button);}, 350);
				}
				else {
					me._vr_button.ggParameter.sx = 1;
					me._vr_button.ggParameter.sy = 1;
					me._vr_button.style.transform=parameterToTransform(me._vr_button.ggParameter);
					setTimeout(function() {skin.updateSize(me._vr_button);}, 350);
				}
			}
		}
		me._vr_button.logicBlock_visible = function() {
			var newLogicStateVisible;
			if (
				((player.hasVR() == false))
			)
			...
			if (me._vr_button.ggCurrentLogicStateVisible != newLogicStateVisible) {
				me._vr_button.ggCurrentLogicStateVisible = newLogicStateVisible;
				me._vr_button.style.transition='transform 300ms ease 0ms';
				if (me._vr_button.ggCurrentLogicStateVisible == 0) {
					me._vr_button.style.visibility="hidden";
					me._vr_button.ggVisible=false;
				}
				else {
					me._vr_button.style.visibility=(Number(me._vr_button.style.opacity)>0||!me._vr_button.style.opacity)?'inherit':'hidden';
					me._vr_button.ggVisible=true;
				}
			}
		}
		me._vr_button.onclick=function (e) {
			player.enterVR();
		}
		me._vr_button.onmouseenter=function (e) {
			me.elementMouseOver['vr_button']=true;
			me._vr_icon_active.logicBlock_alpha();
			me._vr_icon.logicBlock_alpha();
			me._vr_button.logicBlock_scaling();
		}
		me._vr_button.onmouseleave=function (e) {
			me.elementMouseOver['vr_button']=false;
			me._vr_icon_active.logicBlock_alpha();
			me._vr_icon.logicBlock_alpha();
			me._vr_button.logicBlock_scaling();
		}
		me._vr_button.ggUpdatePosition=function (useTransition) {
		}
		el=me._vr_icon_active=document.createElement('div');
		els=me._vr_icon_active__img=document.createElement('img');
		els.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
			...
			'NS0yLjYsMS41SDZjLTEuNywwLTMtMS4zLTMtM3YtOS40QzMsMTMuOCw0LjMsMTIuNyw2LDEyLjd6Ii8+CiA8cG9seWxpbmUgY2xhc3M9InN0MCIgcG9pbnRzPSIxMy4yLDEyLjcgMTMuMiw0LjIgMjIuOCw0LjIgMjIuOCwxMi43ICIvPgo8L3N2Zz4K';
		me._vr_icon_active__img.setAttribute('src',hs);
		hs ='';
		hs += 'position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;pointer-events:none;;';
		els.setAttribute('style', hs);
		els['ondragstart']=function() { return false; };
		...
		el.setAttribute('role', 'button');
		el.style.transformOrigin='50% 50%';
		me._vr_icon_active.ggIsActive=function() {
			if ((this.parentNode) && (this.parentNode.ggIsActive)) {
				return this.parentNode.ggIsActive();
			}
			return false;
		...
		me._vr_icon_active.logicBlock_alpha = function() {
			var newLogicStateAlpha;
			if (
				((me.elementMouseOver['vr_button'] == true))
			)
			...
			if (me._vr_icon_active.ggCurrentLogicStateAlpha != newLogicStateAlpha) {
				me._vr_icon_active.ggCurrentLogicStateAlpha = newLogicStateAlpha;
				me._vr_icon_active.style.transition='opacity 200ms ease 0ms';
				if (me._vr_icon_active.ggCurrentLogicStateAlpha == 0) {
					me._vr_icon_active.style.visibility=me._vr_icon_active.ggVisible?'inherit':'hidden';
					me._vr_icon_active.style.opacity=1;
				}
				else {
					setTimeout(function() { if (me._vr_icon_active.style.opacity == 0.0) { me._vr_icon_active.style.visibility="hidden"; } }, 205);
					me._vr_icon_active.style.opacity=0;
				}
			}
		}
		me._vr_icon_active.onclick=function (e) {
			player.enterVR();
		}
		me._vr_icon_active.ggUpdatePosition=function (useTransition) {
		}
		me._vr_button.appendChild(me._vr_icon_active);
		...
		me._vr_icon.logicBlock_alpha = function() {
			...
			if (me._vr_icon.ggCurrentLogicStateAlpha != newLogicStateAlpha) {
				...
				me._vr_icon.style.transition='opacity 200ms ease 0ms';
				if (me._vr_icon.ggCurrentLogicStateAlpha == 0) {
					setTimeout(function() { if (me._vr_icon.style.opacity == 0.0) { me._vr_icon.style.visibility="hidden"; } }, 205);
		...
		me._vr_button.appendChild(me._vr_icon);
		me.divSkin.appendChild(me._vr_button);
...
pano.on("modelloaded", () => { pano.setVariableValue("model_loading", false); });
		...
		me.elementMouseOver['vr_button']=false;
		me._vr_button.logicBlock_scaling();
		me._vr_button.logicBlock_visible();
		me._vr_icon_active.logicBlock_alpha();
		me._vr_icon.logicBlock_alpha();
